...
public class WorkConsumer
{
    ...
    public void listenWorkQueue1(Message message) throws InterruptedException {
        System.out.println("Consumer 1 received Work queue message : " + new String(message.getBody()));
        Thread.sleep(20);
    }

    @RabbitListener(queues = "work.queue")
    public void listenWorkQueue2(Message message) throws InterruptedException {
        System.out.println("Consumer 2 received Work queue message : " + new String(message.getBody()));
        Thread.sleep(200);
    }
